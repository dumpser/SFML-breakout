...
public:
	...
	static void loadTextureBall(const std::string& name, const std::string& filename);
	static void loadTextureWall(const std::string& name, const std::string& filename);
	static void loadTextureBrick(const std::string& name, const std::string& filename);
